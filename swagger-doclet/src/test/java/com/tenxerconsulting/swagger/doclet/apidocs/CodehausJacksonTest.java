...
class CodehausJacksonTest {
    ...
    void testStart() throws IOException {
        final RootDoc rootDoc = RootDocLoader.fromPath("src/test/resources", "fixtures.codehausjackson");
        new JaxRsAnnotationParser(this.options, rootDoc).run();

        JSONCompare.compare("/fixtures/codehausjackson/jackson.json", recorderMock);
    }

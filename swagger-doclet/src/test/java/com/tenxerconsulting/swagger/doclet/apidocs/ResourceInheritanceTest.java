...
class ResourceInheritanceTest {
    ...
    void testStart() throws IOException {
        final RootDoc rootDoc = RootDocLoader.fromPath("src/test/resources", "fixtures.resourceinheritance");
        new JaxRsAnnotationParser(this.options, rootDoc).run();

        JSONCompare.compare("/fixtures/resourceinheritance/resourceinheritance.json", recorderMock);
    }
